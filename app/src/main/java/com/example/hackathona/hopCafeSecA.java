...
public class hopCafeSecA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            inputStream1 = getAssets().open("hopAt_M.txt");
        } catch (IOException e) {
            e.printStackTrace();
        }

        FileReadInput fileReadInput = new FileReadInput();
        fileReadInput.ReadInput(inputStream1,2);

        ArrayList<Double> EstimateNumOfTimeHop = fileReadInput.allWaitTimeAndPeople.get(2);
                    ...
                    while (!isInterrupted()){
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                TextView timeTxt = (TextView) findViewById(R.id.hopEstTimeA);
